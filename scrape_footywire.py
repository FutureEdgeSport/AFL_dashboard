#!/usr/bin/env python3
"""
Scrape AFL Player Lists from Footywire.com.au
...
def scrape_all_teams(output_file=None):
    ...
    # Save to CSV (atomic write with backup)
    if output_file:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape AFL squad lists from Footywire")
    ...
    # Output file path
    output_file = f"data/raw/player/footywire_{season}_lists.csv"
